...
TTCS <- select(Clinical_data, "EB_id", "clin_stab_hosp_old", "MEWS_score")
...
##
CAP_only$long_TCS <- ifelse(CAP_only$clin_stab_hosp_old >=3, 1, 0)
summary(glm(CAP_only$long_TCS ~ CAP_only$SRSF6 + CAP_only$MEWS_score, family = "binomial"))
summary(glm(CAP_only$long_TCS ~ CAP_only$OGT+ CAP_only$MEWS_score, family = "binomial"))
summary(glm(CAP_only$long_TCS ~ CAP_only$WDR1+ CAP_only$MEWS_score, family = "binomial"))
summary(glm(CAP_only$long_TCS ~ CAP_only$AMPD3+ CAP_only$MEWS_score, family = "binomial"))

CAP_only$long_TCS <- factor(ifelse(CAP_only$clin_stab_hosp_old >=3, 1, 0))
table(CAP_only$long_TCS )
summary(CAP_only$clin_stab_hosp_old)

##
SRSF6 <- ggplot(CAP_only, aes(x = long_TCS, y =SRSF6, fill = long_TCS )) +
  geom_boxplot() +           # Add points
  labs(title = "Scatter Plot of SRSF6 vs Clinical Stability Hospitalization",
       x = "Time to clinical Stability",
       y = "Clinical Stability Hospitalization") +
  scale_fill_manual(values = c("0" = "#4575B4", "1" = "#D73027")) + # Custom colors 
  theme(panel.background = element_rect(fill = "white", color = NA), # Set background to white
        plot.background = element_rect(fill = "white", color = NA),  # Set plot background to white
        panel.grid.major = element_blank(),  # Remove major grid lines
        panel.grid.minor = element_blank(),  # Remove minor grid lines
        axis.line = element_line(color = "black"),  # Ensure axes lines are black
        axis.ticks = element_line(color = "black"))  # Ensure ticks are black if needed

OGT <- ggplot(CAP_only, aes(x = long_TCS, y =OGT, fill = long_TCS )) +
  geom_boxplot() +           # Add points
  labs(title = "Scatter Plot of OGT vs Clinical Stability Hospitalization",
       x = "Time to clinical Stability",
       y = "Clinical Stability Hospitalization") +
  scale_fill_manual(values = c("0" = "#4575B4", "1" = "#D73027")) + # Custom colors 
  theme_minimal()     +
...
WDR1 <- ggplot(CAP_only, aes(x = long_TCS, y =WDR1, fill = long_TCS )) +
  geom_boxplot() +           # Add points
  labs(title = "Scatter Plot of WDR1 vs Clinical Stability Hospitalization",
       x = "Time to clinical Stability",
       y = "Clinical Stability Hospitalization") +
  scale_fill_manual(values = c("0" = "#4575B4", "1" = "#D73027")) + # Custom colors 
  theme_minimal()  +
...
AMPD3 <- ggplot(CAP_only, aes(x = long_TCS, y =AMPD3, fill = long_TCS )) +
  geom_boxplot() +           # Add points
  labs(title = "Scatter Plot of AMPD3 vs Clinical Stability Hospitalization",
       x = "Time to clinical Stability",
       y = "Clinical Stability Hospitalization") +
  theme_minimal()    +
  scale_fill_manual(values = c("0" = "#4575B4", "1" = "#D73027")) + # Custom colors 
...
ggarrange(SRSF6, OGT, WDR1, AMPD3, legend = "bottom", common.legend = T)
...
summary(glm(CAP_only$long_TCS ~ CAP_only$CTSD+ CAP_only$MEWS_score, family = "binomial"))
summary(glm(CAP_only$long_TCS ~ CAP_only$PCNA+ CAP_only$MEWS_score, family = "binomial"))
summary(glm(CAP_only$long_TCS ~ CAP_only$LTF+ CAP_only$MEWS_score, family = "binomial"))
summary(glm(CAP_only$long_TCS ~ CAP_only$ORM1+ CAP_only$MEWS_score, family = "binomial"))

##
CTSD <- ggplot(CAP_only, aes(x = long_TCS, y =CTSD, fill = long_TCS )) +
  geom_boxplot() +           # Add points
  labs(title = "Scatter Plot of CTSD vs Clinical Stability Hospitalization",
       x = "Time to clinical Stability",
       y = "Clinical Stability Hospitalization") +
  theme_minimal()    +
  scale_fill_manual(values = c("0" = "#4575B4", "1" = "#D73027")) + # Custom colors 
...
PCNA <- ggplot(CAP_only, aes(x = long_TCS, y =PCNA, fill = long_TCS )) +
  geom_boxplot() +           # Add points
  labs(title = "Scatter Plot of PCNA vs Clinical Stability Hospitalization",
       x = "Time to clinical Stability",
       y = "Clinical Stability Hospitalization") +
  theme_minimal()    +
  scale_fill_manual(values = c("0" = "#4575B4", "1" = "#D73027")) + # Custom colors 
...
LTF <- ggplot(CAP_only, aes(x = long_TCS, y =LTF, fill = long_TCS )) +
  geom_boxplot() +           # Add points
  labs(title = "Scatter Plot of LTF vs Clinical Stability Hospitalization",
       x = "Time to clinical Stability",
       y = "Clinical Stability Hospitalization") +
  theme_minimal()    +
  scale_fill_manual(values = c("0" = "#4575B4", "1" = "#D73027")) + # Custom colors 
...
ORM1 <- ggplot(CAP_only, aes(x = long_TCS, y =ORM1, fill = long_TCS )) +
  geom_boxplot() +           # Add points
  labs(title = "Scatter Plot of ORM1 vs Clinical Stability Hospitalization",
       x = "Time to clinical Stability",
       y = "Clinical Stability Hospitalization") +
  theme_minimal()    +
  scale_fill_manual(values = c("0" = "#4575B4", "1" = "#D73027")) + # Custom colors 
...
ggarrange(CTSD, PCNA, LTF, ORM1, legend = "bottom", common.legend = T)
...
## save
plasma_clean_save <- t_plasma_clean
